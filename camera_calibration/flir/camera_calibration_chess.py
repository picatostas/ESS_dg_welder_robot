...
# square size in mm
square_size = 25
# chessboard size, inner grids (not outer column, row)
chess_rows = 6
chess_columns = 9
...
# To estimate how much the calibration parameters differ from the ideal calibration
mean_error = 0
tot_error = 0
for i in xrange(len(objpoints)):
    ...
    tot_error += error
    # print(tot_error)
mean_error = float(tot_error)/len(objpoints)
print("total error: %.4f" % mean_error)
